                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="clas_id" class="form-control">
                                            ...
                                            @foreach ($classes as $class)
                                                <option value="{{ $class->id }}" {{ $routine->clas_id == $class->id ? 'selected':'' }}>{{ $class->class_name }}</option>
                                            @endforeach
                                        </select>
                                        @error('clas_id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="subject_id" class="form-control">
                                            ...
                                            @foreach ($subjects as $subject)
                                                <option value="{{ $subject->id }}" {{ $routine->subject_id == $subject->id ? 'selected':'' }}>{{ $subject->subject }}</option>
                                            @endforeach
                                        </select>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <select name="exam_id" class="form-control">
                                             ...
                                             @foreach ($exams as $exam)
                                                 <option value="{{ $exam->id }}" {{ $routine->exam_id == $exam->id ? 'selected':'' }}>{{ $exam->exam_name }}</option>
                                             @endforeach
                                         </select>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <select name="session_id" class="form-control">
                                             ...
                                             @foreach ($sessions as $session)
                                                 <option value="{{ $session->id }}" {{ $routine->session_id == $session->id ? 'selected':'' }}>{{ $session->session_year }}</option>
                                             @endforeach
                                         </select>
                             ...
                             <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="room_no" value="{{ $routine->room_no }}" class="form-control">
                             ...
                             <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date" value="{{ date('Y-m-d', strtotime($routine->date))}}"  class="form-control">
