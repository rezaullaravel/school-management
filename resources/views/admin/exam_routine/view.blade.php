            ...
            <div class="col-sm-10 offset-sm-1">
                <div class="card">
                    <div class="card-header">
                        <h4>View Exam Routine.
                            <a href="{{ url('admin/e_xamination/routine') }}" class="btn btn-primary" style="float: right;">Back</a>
                        </h4>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('admin.exam-routine.view') }}" method="GET">
