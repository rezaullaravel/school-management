            ...
            <div class="col-sm-10 offset-sm-1">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-body">
                          <form action="{{ route('teacher.student.attendence.report') }}" method="GET">
                              ...
                              <tbody>
                                 @foreach ($attendences as $key=>$row)
                                     <tr>
                                         ...
                                         <td>
                                            <a href="{{ route('teacher.attendence.student.edit',$row->id) }}" class="btn btn-info" title="Edit"><i class="las la-pen"></i> </a>
                                         </td>
                                     </tr>
                                 @endforeach
                              </tbody>
