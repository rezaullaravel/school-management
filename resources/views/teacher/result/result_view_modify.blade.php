                        ...
                        <table class="table table-bordered">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $grade_name }}</td>
                                <td>
                                <a href="{{route('teacher.result.edit',$mark->id)}}" class="btn btn-info btn-sm" title="Edit"><i class="las la-pen"></i></a>
                                <a href="{{route('teacher.result.delete',$mark->id)}}" class="btn btn-danger btn-sm" onclick="confirmation(event)" title="Delete"><i class="las la-trash"></i></a>
                                </td>
