<footer>
        ...
        <div class="row py-xl-5 py-sm-3">
            <div class="col-lg-6 map">
                ...
                <div class="conta-posi-w3ls p-4 rounded">
                    ...
                    <p>22/7
                        <span>Singra street,</span> Natore, Bangladesh.</p>
                </div>
            </div>
            <div class="col-lg-6 contact-agileits-w3layouts mt-lg-0 mt-4">
                ...
                <p class="conta-para-style border-left pl-4">If you have any questions please contact us through the given phone and email.We try and respond to all queries and comments within 24 hours.</p>
                ...
                <p class="para-agileits-w3layouts text-white">
                    <i class="fas fa-map-marker pr-3"></i>22/7 Singra, Natore, Bangladesh.</p>
                <p class="para-agileits-w3layouts text-white my-sm-3 my-2">
                    <i class="fas fa-phone pr-3"></i>+8801719475187</p>
                <p class="para-agileits-w3layouts">
                    <i class="far fa-envelope-open pr-2"></i>
                    <a href="mailto:mail@example.com" class=" text-white">info@myschool.com</a>
                </p>
            </div>
        </div>
    </div>
    <div class="copyright-agiles py-3">
        <div class="container">
            <div class="row">
                <p class="col-lg-8 copy-right-grids text-white text-lg-left text-center mt-lg-1">© 2024 MySchool. All Rights Reserved | Design by
                    <a href="#" target="_blank">Hr IT</a>
                </p>
                <!-- social icons -->
