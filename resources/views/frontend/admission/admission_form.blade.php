                ...
                <div class="card-body">
                    <form action="{{ route('store.admission.info') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="clas_id" id="" class="form-control">
                                        <option value="" selected disabled>Select A Trade</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>S.S.C Roll <span class="text-danger">*</span></label>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>S.S.C Registration <span class="text-danger">*</span></label>
